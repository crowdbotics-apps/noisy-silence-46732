"""
Django settings for noisy_silence_46732 project.
...
ROOT_URLCONF = 'noisy_silence_46732.urls'
...
WSGI_APPLICATION = 'noisy_silence_46732.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "noisy_silence_46732 API",
    "DESCRIPTION": "API documentation for noisy_silence_46732 App",
    "VERSION": "v1",
}
